TicTacToe game made in Java, where you can chose to play against an opponent friend or against computer. This game contain a 3x3 cells board where you have to input an "X'
